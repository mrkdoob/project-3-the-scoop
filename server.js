...
function deleteComment(url, request){
  ...
  if (savedComment) {
    ...
    database.users[user].commentIds = database.users[user].commentIds.filter(commentId => commentId !== id);

    const articleId = savedComment.articleId;
    database.articles[articleId].commentIds = database.articles[articleId].commentIds.filter(articleArrayId => articleArrayId !== articleId);
...
function createComment(url, request){
  ...
  if (requestComment && requestComment.username && requestComment.articleId && requestComment.body && database.articles[requestComment.articleId] && database.users[requestComment.username]) {
    const comment = {
